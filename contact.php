        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5">
            ...
            <div class="info-wrap">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11105.728589526683!2d6.088871576175817!3d45.902669119360176!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478b85424733ecd1%3A0x8c6994e9aa5cb8de!2sCran-Gevrier%2C%2074960%20Annecy!5e0!3m2!1sfr!2sfr!4v1719238658366!5m2!1sfr!2sfr"
          ...
          <div class="col-lg-7">
            <form enctype="multipart/form-data" action="formcheck.php" method="post" class="php-email-form"
              ...
              <div class="row gy-4">
                ...
                <div class="col-md-4">
                  ...
                  <!-- La classe form-control peret de controler avec bootstrap la validation du champ -->
                  <input type="text" name="last-name" id="name-field" class="form-control" required=""
                    value="<?php echo $_SESSION["last-name"];
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" class="form-control" name="subject" id="subject-field1"
                      required="">
                    <label class="form-check-label" for="subject-field1">Demande d'information</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" class="form-control" name="subject" id="subject-field2"
                      required="">
                    <label class="form-check-label" for="subject-field2">Projet</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" class="form-control" name="subject" id="subject-field3"
                      required="">
                ...
                <div class="col-md-12">
                  ...
                  <textarea class="form-control" name="message" rows="10" id="message-field" required=""
                    ...
                    unset($_SESSION["message"]); ?>"></textarea>
                </div>
                ...
                <div class="col-md-12 text-center">
                  ...
                  <div class="sent-message">Votre message a bien été envoyé ! Je vous recontacte dès que possible !
                  </div>
